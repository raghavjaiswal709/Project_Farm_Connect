...
const FarmerDashboard1 = () => {
  ...
  return (
    ...
    <div className='fDashboardSecContainer'>
        ...
        <a className='loginas-buttDash' href='/Dashboard/AddNewProductFarmer  '>Add New product</a>
        <a className='loginas-buttDash' href='#'>View all product</a>
        <a className='loginas-buttDash' href='#'>View accepted product</a>
        <a className='loginas-buttDash' href='/ManageCategory'>manage category</a>

        </section>
        <section>
        <img className='blinkingfarmerpng' src={blinkingFarmer} alt='blinking farmer' />
        </section>
    </div>
    </div>
